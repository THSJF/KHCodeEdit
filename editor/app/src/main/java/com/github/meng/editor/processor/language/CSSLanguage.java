...
package com.github.meng.editor.processor.language;

import com.github.meng.editor.processor.utils.text.ArrayUtils;
...
public class CSSLanguage extends Language {
     ...
     */
    private static final String[] ALL_KEYWORDS = ArrayUtils.join(CSS_KEYWORDS);
