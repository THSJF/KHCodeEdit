package com.github.meng.editor.widget;
...
import com.github.meng.editor.adapter.*;
import com.github.meng.editor.document.commons.*;
import com.github.meng.editor.keyboard.*;
import com.github.meng.editor.processor.*;
import com.github.meng.editor.processor.language.*;
...
public class CodeEditor extends FrameLayout {
    ...
    public static void setCodeView(CodeEditor view, String code, String lang,boolean isReadOnly,boolean isShowExtendedKeyboard) {
        if (view == null) {
            return;
        }
        if (code != null) {
    ...
    private void init(final Context context, AttributeSet attrs) {
        try {
            ...
            final FrameLayout.LayoutParams paramsTxtprocessor = new FrameLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT);
			...
			recyclerView.setListener(new ExtendedKeyboard.OnKeyListener(){

					@Override
					public void onKeyClick(View view, Symbol symbol) {
